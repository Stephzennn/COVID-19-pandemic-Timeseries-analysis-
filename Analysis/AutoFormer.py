...
FinalFloridaCombinedData = pd.read_csv("/content/FinalFloridaCombinedData.csv")
...
for hidden_size in hidden_sizes:
    for conv_hidden_size in conv_map[hidden_size]:
        for lr in learning_rates:
            for n_head in n_heads_map[hidden_size]:
                for enc_layers in encoder_layers:
                    for dec_layers in decoder_layers:
                        model = Autoformer(
                            h=1,                      
